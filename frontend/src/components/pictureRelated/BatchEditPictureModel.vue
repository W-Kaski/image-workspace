<template>
  <div class="batch-edit-picture-modal">
    <a-modal v-model:visible="visible" title="Batch Edit Picture" :footer="false" @cancel="closeModal">
      <a-typography-paragraph type="secondary">* only edit pictures on current page</a-typography-paragraph>
      <!-- 批量创建表单 -->
      <a-form name="formData" layout="vertical" :model="formData" @finish="handleSubmit">
        ...
        <a-form-item name="nameRule" label="nameRule">
          <a-input
            v-model:value="formData.nameRule"
            placeholder="please enter name rule"
            allow-clear
          />
        </a-form-item>
        <a-form-item>
